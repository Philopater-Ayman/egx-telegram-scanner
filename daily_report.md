...
Generated UTC: 2026-06-16T19:57:16.783748+00:00
Generated Cairo: 2026-06-16 22:57
Run timing: target 19:30 Cairo | generated Cairo 2026-06-16 22:57 | cron 30 16 * * 0-4
Trigger: scheduled cron=30 16 * * 0-4 mapped to evening_plan; Cairo now 2026-06-16 22:54
...
- Summary: The EGX30 and EGX70 indices are both in a bearish regime with weak breadth (28.57%). Liquidity is modest and most stocks sit near short‑term resistance, so the scanner flags a defensive risk mode (no new buys). The top sectors – Automotive & Distribution, Agriculture & Food Production, and Real Estate – show some bullish watch signals, but overall market conditions limit actionable opportunities for the next 1‑3 days.
- EGX30/EGX70 bearish, below MA20, sector breadth weak → defensive risk mode
- Top sectors show bullish watch but stocks sit close to resistance levels
- Liquidity spikes present, yet overall market liquidity is modest and cooling
- Support levels are 5‑27% away; resistance within 1‑2% suggests limited upside
- Uncertainty remains high due to bearish index trends and low breadth
...
- AMOC.CA: score=10.28 buy_ready=False sector_rank=10 price=7.85 support=7.71 resistance=9.15 source=Yahoo Finance history + Mubasher delayed current trading data as_of=01:29 PM market time freshness=DELAYED_CURRENT RSI=29.36 liquidity=31812788.0 spike=0.42
...
- EGAS.CA: score=14.08 buy_ready=False sector_rank=10 price=51.15 support=47.15 resistance=55.0 source=Yahoo Finance history + Mubasher delayed current trading data as_of=01:25 PM market time freshness=DELAYED_CURRENT RSI=72.5 liquidity=3796864.25 spike=0.3
...
- MOIL.CA: score=8.32 buy_ready=False sector_rank=10 price=0.47 support=0.44 resistance=0.49 source=Yahoo Finance history + Mubasher delayed current trading data as_of=01:29 PM market time freshness=DELAYED_CURRENT RSI=56.45 liquidity=36374.89 spike=0.22
