...
Generated UTC: 2026-06-01T13:09:17.824135+00:00
...
- Summary: The local scanner found no stock meeting evidence, liquidity, freshness, and technical gates, so all tickets are HOLD. EGX30 remains bearish with weak breadth below MA20, while EGX70 is constructive, supporting a selective small‑mid swing risk mode. Leading sectors (Tech & Distribution, Telecom, Tourism) show decent breadth, but liquidity gaps keep the top‑ranked tickets out of play for the next 1‑3 days.
- Liquidity missing on all candidates – volume below minimum and cooling, limiting near‑term tradeability.
- Technical outlooks range from neutral to weak/risky; most are near resistance with limited upside in 1‑3 days.
- EGX30 bearish regime adds downside pressure; EGX70 constructive backdrop offers limited upside in selective sectors.
- Sector breadth strong (85.7%); however, lack of fresh liquidity overrides sector strength.
- Uncertainty high – no clear entry signals; monitor liquidity and any breakout from resistance before revisiting.
